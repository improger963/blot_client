...
export const GameRoomPage = () => {
    ...
    return (
        <div className="min-h-screen bg-grid flex flex-col relative overflow-hidden">
            {/* Header */}
            <motion.header
            ...
            <div className="lg:hidden flex-1 flex flex-col p-4 space-y-4">
                ...
                <motion.div
                    ...
                    className="rounded-2xl bg-surface/50 p-4 glass material-depth-1"
                >
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-1 -right-1 h-3 w-3 rounded-full bg-surface bg-green-400"></div>
                            </div>
                            <div>
                ...
                >
                    <div className="relative w-full h-64 rounded-2xl bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center shadow-lg glass material-depth-3">
                        {/* Community Cards */}
                        ...
                        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
                            <div className="bg-yellow-500/20 rounded-full px-4 py-2">
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            <Button variant="secondary" className="w-full h-12 rounded-xl font-semibold">
                                Колл $20
                            </Button>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            <div className="hidden lg:flex flex-1 p-6 gap-6">
                ...
                >
                    {/* Players List */}
                    <div className="rounded-2xl bg-surface/50 p-6 flex-1 glass material-depth-2">
                            ...
                            <AnimatePresence>
                                {players.map((player, index) => (
                                    <motion.div
                                        ...
                                        className={`flex items-center justify-between p-3 rounded-xl transition-all duration-200 glass-hover ${
                                            player.isActive
                                                ? 'bg-primary/5'
                                                : 'bg-card/30'
                                        }`}
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="relative">
                                                ...
                                                {player.isActive && (
                                                    <div className="absolute -bottom-1 -right-1 h-2 w-2 rounded-full bg-surface bg-green-400"></div>
                                                )}
                                            </div>
                                            <div>
                    ...
                    {/* Chat */}
                    <div className="rounded-2xl bg-surface/50 p-6 flex-1 flex flex-col glass material-depth-2">
                        <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
                            <MessageCircleIcon className="h-5 w-5 text-primary" />
                            Чат стола
                        </h3>
                        <div className="bg-card/30 rounded-xl p-3 flex-1 mb-3 overflow-y-auto glass">
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 rounded-xl bg-surface px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
                            />
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                    <div className="flex-1 flex items-center justify-center p-8">
                        <div className="relative w-full h-96 rounded-2xl bg-gradient-to-br from-primary/10 to-secondary/10 shadow-2xl flex items-center justify-center glass material-depth-3">
                            {/* Community Cards */}
                            <div className="flex gap-3 mb-24">
                                {[1, 2, 3, 4, 5].map((card) => (
                                    <motion.div
                                        ...
                                        className="w-16 h-24 bg-white rounded-xl shadow-xl flex items-center justify-center"
                                    >
                            ...
                            <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
                                <div className="bg-yellow-500/20 rounded-full px-6 py-3">
                    ...
                    <motion.div
                        ...
                        className="rounded-2xl bg-surface/50 p-6 mx-8 mb-6 glass material-depth-2"
                    >
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Button variant="ghost" className="w-full h-14 rounded-xl font-semibold text-base">
                                    Пас
                                </Button>
                            </motion.div>
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Button variant="secondary" className="w-full h-14 rounded-xl font-semibold text-base">
                                    Колл $20
                                </Button>
                            </motion.div>
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Button className="w-full h-14 rounded-xl font-semibold text-base shadow-lg">
                                    Рейз $40
                                </Button>
                            </motion.div>
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Button variant="primary" className="w-full h-14 rounded-xl font-semibold text-base shadow-lg">
                                    Все-ин $1000
                                </Button>
                            </motion.div>
                        </div>
